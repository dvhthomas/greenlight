...
func (app *application) showMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// Missed this `return` initially and was getting errors when `writeJSON` was attempting
		// to still write headers: `http: superfluous response.WriteHeader call from main.`
		return
	}
